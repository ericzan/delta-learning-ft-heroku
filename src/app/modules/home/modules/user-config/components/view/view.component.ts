...
export class ViewComponent implements AfterViewInit {
  ...
  constructor(protected fieldValidate: FieldValidateService,private fb: FormBuilder, private uiOperGrService: UiOperGrService,private messageService: MessageService) {
    this.form = fb.group({
      username: [{
        value: '',
        disabled: true
